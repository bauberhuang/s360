...
# Load image & get data
# image = pygame.image.load("nishioi.jpg").convert()
...
video = cv2.VideoCapture("nishioi.mp4")
...
while running:
    ...
    # frame = cv2.resize(frame, (img_width, img_height))  # Optional resize
    panorama_pixels = np.transpose(frame, (1, 0, 2)) 
    # === Input Handling ===
